...
class ReverbProcessorCustom
{
public:
    //==============================================================================
    ReverbProcessorCustom()
    {
    ...
    */
    ...
    //Setting LPF
    void setLPF (const juce::dsp::ProcessSpec& spec)
    {
        lpf.prepare(spec);
        lpf.setType(juce::dsp::FirstOrderTPTFilterType::lowpass);
//        lpf.setCutoffFrequency(500.0f);
    }
    
    void setLPFCutoffFreq (float& cutoffFreq)
    {
        lpf.setCutoffFrequency(cutoffFreq);
    }
    ...
    */
    ...
    void processStereo (float* const left, float* const right, const int numSamples) noexcept
    {
        ...
        for (int i = 0; i < numSamples; ++i)
        {
            ...
            outL = lpf.processSample(0, outL);
            outR = lpf.processSample(0, outR);
    ...
    void processMono (float* const samples, const int numSamples) noexcept
    {
        ...
        for (int i = 0; i < numSamples; ++i)
        {
            ...
            output = lpf.processSample(0, output);
...
private:
    ...
    dsp::FirstOrderTPTFilter<float> lpf;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ReverbProcessorCustom)
};
